...
<svg id="fl" width="100%" height="100%" viewBox="30 -280 760 1000"  >
 <path id="path">
		<animate attributeName="d" from="m0,110 h0" to="m0,110 h1100" dur="10.8s" begin="0s" repeatCount="indefinite"/>
	</path>
	<text font-size="34" stroke="black" font-family="Montserrat" fill='hsla(36, 95%, 85%, 1)'>
		<textPath xlink:href="#path">Kris Portfolio Inspired Collection by Web Animation Techniques
    </textPath>
	</text>
  </svg></div> 
  <svg id="fl1">
  
    <g>  <text x="400" y="280" font-family="'Bowlby One SC', cursive" font-size="100" fill="white" stroke= "black" stroke-width="2">WELCOME</text></g> </svg>
