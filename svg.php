...
section#topper { }
  section#topper .background {
    ...
    background: -webkit-linear-gradient( #75c9f0 1%, #0A2A39 1%, #0A2A39 51%, #bfbada 100%);
    }
...
<a class="button button1" href="LT5.php">Learning Task 5.1</a>
<a class="button button2" href="LT6.1.php">Learning Task 6.1</a>
<a class="button button3" href="LT6.php">Learning Task 6.2</a>

<a class="button" href="midterm.php">Culminating Learning Evidence (MIDTERM)</a>
